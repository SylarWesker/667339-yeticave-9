...
<main>
  ...
  <form class="form form--add-lot container <?php if($has_errors) echo $form_invalid_class; ?>" action="add.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
    ...
    <div class="form__container-two">
      <div class="form__item <?php if(isset($errors['lot-name'])) echo $form_item_invalid_class; ?>">
        <label for="lot-name">Наименование <sup>*</sup></label>
        <input id="lot-name" type="text" name="lot-name" placeholder="Введите наименование лота" value="<?= show_form_data('lot-name', $form_data); ?>">
      ...
      <div class="form__item <?php if(isset($errors['category'])) echo $form_item_invalid_class; ?>">
        ...
        <select id="category" name="category">
          <?php foreach($stuff_categories as $category): ?>
            <option <?php if ($category['name'] === show_form_data('category', $form_data)) echo 'selected';?>><?= $category['name']; ?></option>
          <?php endforeach; ?>
        </select>
    ...
    <div class="form__item form__item--wide <?php if(isset($errors['message'])) echo $form_item_invalid_class; ?>">
      ...
      <textarea id="message" name="message" placeholder="Напишите описание лота"><?= show_form_data('message', $form_data); ?></textarea>
    ...
    <div class="form__container-three">
      <div class="form__item form__item--small <?php if(isset($errors['lot-rate'])) echo $form_item_invalid_class; ?>">
        ...
        <input id="lot-rate" type="text" name="lot-rate" placeholder="0" value="<?= show_form_data('lot-rate', $form_data); ?>">
      ...
      <div class="form__item form__item--small <?php if(isset($errors['lot-step'])) echo $form_item_invalid_class; ?>">
        ...
        <input id="lot-step" type="text" name="lot-step" placeholder="0" value="<?= show_form_data('lot-step', $form_data); ?>">
      ...
      <div class="form__item <?php if(isset($errors['lot-date'])) echo $form_item_invalid_class; ?>">
        ...
        <input class="form__input-date" id="lot-date" type="text" name="lot-date" placeholder="Введите дату в формате ГГГГ-ММ-ДД" value="<?= show_form_data('lot-date', $form_data); ?>">
