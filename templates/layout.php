...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <a class="main-header__add-lot button" href="add.php">Добавить лот</a> <!-- href="pages/add-lot.html" -->
...
<footer class="main-footer">
    ...
    <div class="main-footer__bottom container">
        ...
        <a class="main-footer__add-lot button" href="add-lot.html">Добавить лот</a> <!-- ToDo тут тоже заменить на add.php. было href="add-lot.html"-->
